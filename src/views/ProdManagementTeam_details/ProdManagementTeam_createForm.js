...
const CreateProdManagementTeamForm = () => {
  ...
  const submitForm = async () => {
      ...
      try {
        const resp = await makeApiCall(
          `${BASE_URL}${PATH_PRODMANAGEMENTTEAM}`,
          'POST',
          JSON.stringify({
            ...otherData,
                          })
        ...
        if (resp.ok) {
          snackbar.enqueueSnackbar('Successfully created ProdManagementTeam', {
            variant: 'success',
          });
...
export default CreateProdManagementTeamForm;
